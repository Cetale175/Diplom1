...
class AboutFragment : Fragment(R.layout.fragment_about) {
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        with(binding.containerCustomAppBarIncludeOnFragmentAbout) {
            ourMissionImageButton.visibility = View.INVISIBLE
            authorizationImageButton.visibility = View.INVISIBLE
            mainMenuImageButton.visibility = View.INVISIBLE
            aboutBackImageButton.visibility = View.INVISIBLE
        }
