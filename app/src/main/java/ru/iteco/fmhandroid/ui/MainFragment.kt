...
class MainFragment : Fragment(R.layout.fragment_main) {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.containerListNewsIncludeOnFragmentMain.apply {
            sortNewsMaterialButton.visibility = View.INVISIBLE
            filterNewsMaterialButton.visibility = View.INVISIBLE
            editNewsMaterialButton.visibility = View.INVISIBLE

            expandMaterialButton.setOnClickListener {
                when (allNewsTextView.visibility) {
                    View.INVISIBLE -> {
                        allNewsTextView.visibility = View.INVISIBLE
                        allNewsCardsBlockConstraintLayout.visibility = View.INVISIBLE
